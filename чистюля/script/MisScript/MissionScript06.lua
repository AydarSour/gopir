...
--									--
--									--
--npcscripts06.lua Created by Robin.Zeng 2005.9.22.				--
--									--
--									--
--------------------------------------------------------------------------
...
-----------------------------------ФЩАґТ»±­
	...
	MisBeginTalk( "<t>Ой ой....Последней каплей моего вина нет! Но я все еще жажду больше...<n><t>Молодой авантюрист, сделал меня знаменитым \"Drunkern Dream\" from Argent bar. Быстрей!<n><t>Сашими наверное подойдут..." )
