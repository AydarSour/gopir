...
--Языковой барьер
	...
	MisBeginTalk( "<t>Привет, это говорит <yРецепт говорящего зелья>. Даже не спрашивай, почему я умею разговаривать.<n><t>И не вздумай поджигать меня! Хорошо, хорошо, ты выиграл, я расскажу тебе, как создать говорящее зелье. Значит так, тебе понадобится: <r60> <bПолосатых рыбьих костей>, <r60> <bТолстых рыбьих костей>, <r60> <bГнилых рыбьих костей> и <r10> <bСветящихся покров медуз>. Да, это все. Всего 4 ингредиента. Когда ты соберешь их все, отнеси меня и эти ингредиенты <rМастеру Керра>, и он поможет тебе создать это зелье.")
	MisHelpTalk( "<t>Привет, это говорит <yРецепт говорящего зелья>. Даже не спрашивай, почему я умею разговаривать.<n><t>И не вздумай поджигать меня! Хорошо, хорошо, ты выиграл, я расскажу тебе, как создать говорящее зелье. Значит так, тебе понадобится: <r60> <bПолосатых рыбьих костей>, <r60> <bТолстых рыбьих костей>, <r60> <bГнилых рыбьих костей> и <r10> <bСветящихся покров медуз>. Да, это все. Всего 4 ингредиента. Когда ты соберешь их все, отнеси меня и эти ингредиенты <rМастеру Керра>, и он поможет тебе создать это зелье.")
	MisBeginAction(AddMission, 30)
	MisBeginAction(TakeItem, 4256, 1)
	MisBeginAction(AddTrigger, 301, TE_GETITEM, 4938, 60)
	MisBeginAction(AddTrigger, 302, TE_GETITEM, 4957, 60)
	MisBeginAction(AddTrigger, 303, TE_GETITEM, 4976, 60)
	...
	TriggerAction( 1, AddNextFlag, 60, 1, 60 )
	RegCurTrigger( 301 )
	InitTrigger()
	TriggerCondition( 1, IsItem, 4957 )
	TriggerAction( 1, AddNextFlag, 60, 31, 60 )
	RegCurTrigger( 302 )
	InitTrigger()
	TriggerCondition( 1, IsItem, 4976 )
	TriggerAction( 1, AddNextFlag, 60, 61, 60 )
	RegCurTrigger( 303 )
	InitTrigger()
	TriggerCondition( 1, IsItem, 4974 )
	TriggerAction( 1, AddNextFlag, 60, 91, 60 )
	RegCurTrigger( 304 )
