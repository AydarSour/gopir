...
function ser_str()
	Talk( 1, "Даватель сертификатов : _Чтобы получить сертификат силы, тебе нужно принести мне 20 кристальной руды и 99 ясеневых бревен и руну  и 30к золотых " )

	
	InitTrigger()
	TriggerCondition( 1, HasItem, 4546, 20 )
	TriggerCondition( 1, HasItem, 3839, 99 )
	...
	TriggerAction( 1, GiveItem, ID_SERTIFIKAT, 1, 4 )
	TriggerFailure(  1, JumpPage, 1 )
	Text( 1, "Получить сертификат",MultiTrigger, GetMultiTrigger(), 1)
end
