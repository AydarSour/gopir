...
function map_copy_run_special_garner2( map_copy )
	...
	--Notice("Сечайс "..now_miniute.." минут ")
	Every_Check_minute = Every_Check_minute + 1
	if Every_Check_minute == 1 then
		Every_5_minute = 0
	end
	if Every_Check_minute >= 2 then
		Every_5_minute = math.floor( now_miniute / 5 )
	end
	...
	if Every_5_minute == 4 then
		notice_game = "появилась <<4>> волна - 'Слабые монстры'!"
	...
	if Every_5_minute == 5 then
		notice_game = "появилась <<5>> волна - 'Стандартные монстры'!"
	...
	if Every_5_minute == 6 then
		notice_game = "появилась <<6>> волна - 'Сильные монстры'!"
	...
	if Every_5_minute == 7 then
		notice_game = "появилась <<7>> волна - 'Элитные монстры'!"
	...
	if HowManyNoDead == 1 then
		Notice("В Серебрянном Хаосе "..notice_game)
		Notice("В Серебрянном Хаосе все ещё есть выживший: "..HowManyNoDead.." игрок!")
	elseif HowManyNoDead >= 2 then
		Notice("В Серебрянном Хаосе "..notice_game)
		Notice("В Серебрянном Хаосе все ещё есть выжившие: "..HowManyNoDead.." игроков, кому же достанется главный приз?!")
	elseif HowManyNoDead == 0 then
		Notice("В Серебрянном Хаосе "..notice_game)
		Notice("В Серебрянном Хаосе нет выживших, на этот раз Монстры одержат победу!")
	end
...
function GiveSpecItemgarner2( role )
	...
	if How_Many_Active == 1 then
		...
		local message = "В сегодняшней битве выжил только один игрок <<"..cha_name..">>. Он получает ".. Money_Garner2 .." золота и Эмблему Короля Ринга."
		Notice( message )
		return
	end
end 
