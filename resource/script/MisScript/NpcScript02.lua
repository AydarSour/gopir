...
function GoToWhere()
	...
	Text( 1, "Отправиться на остров Зимы", JumpPage, 31 )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 4, "Ты хочешь отправиться в Аргент? Нет проблем, стоимость перемещения стоит 20000 золотых. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 5, "Я обожаю Шайтан. Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 6, "Ты хочешь отправиться в Громоград? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 7, "Ты хочешь отправиться в Ледынь? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 8, "Ты хочешь отправиться в Халдейский Оплот? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 11, "Ты хочешь отправиться в Заброшенные шахты? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 12, "Ты хочешь отправиться в Скалистый удел? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 13, "Ты хочешь отправиться в Валхаллу? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 14, "Ты хочешь отправиться в Обитель радости? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerAction( 2, GoTo, GoTo05X, GoTo05Y, GoTo05M )
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 15, "Ты хочешь отправиться в Халдейский оплот? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 16, "Ты хочешь отправиться в Андийский лес? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
...
--
	...
	Text( 18, "Отправиться на остров Зимы", JumpPage, 31 )
	...
	TriggerCondition( 2, HasMoney, 500000 )
	TriggerAction( 2, TakeMoney, 500000 )
	TriggerAction( 2, GoTo, GoTo21X, GoTo21Y, GoTo21M )
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 31, "Ты хочешь отправиться на Остров Зимы? Заплати мне 500000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 20, "Ты хочешь отправиться в Гавань Оазиса? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 21, "Ты хочешь отправиться в Рощу акаций? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
...
--	Text( 23, "Отправиться на остров Зимы", JumpPage, 2 )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 25, "Ты хочешь отправиться в Пустошь Ледыни? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 26, "Ты хочешь отправиться в Бухту Атлантис? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 27, "Ты хочешь отправиться в Берег Скелетов? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 28 )
	Talk( 9, "Ты хочешь отправиться в Ледяной шип? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
...
--	Text( 12, "Отправиться в Ледынь", JumpPage , 31 )
	...
	Talk( 13, "Ты хочешь отправиться в Заброшенные шахты? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	Text( 13, "Переместиться",MultiTrigger, GetMultiTrigger(), 2 ) 
	Text( 13, CancelSelectTalk, JumpPage , CancelSelectPage )
	...
	TriggerFailure( 2, JumpPage, 26 )
	Talk( 14, "Ты хочешь отправиться в Скалистый удел? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	Text( 14, "Переместиться",MultiTrigger, GetMultiTrigger(), 2 ) 
	Text( 14, CancelSelectTalk, JumpPage , CancelSelectPage )
	...
	TriggerFailure( 2, JumpPage, 26 )
	Talk( 15, "Ты хочешь отправиться в Валхаллу? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	Text( 15, "Переместиться",MultiTrigger, GetMultiTrigger(), 2 ) 
	Text( 15, CancelSelectTalk, JumpPage , CancelSelectPage )
	...
	TriggerFailure( 2, JumpPage, 26 )
	Talk( 16, "Ты хочешь отправиться в Обитель радости? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	Text( 16, "Переместиться",MultiTrigger, GetMultiTrigger(), 2 ) 
	Text( 16, CancelSelectTalk, JumpPage , CancelSelectPage )
	...
	TriggerFailure( 2, JumpPage, 26 )
	Talk( 17, "Ты хочешь отправиться в Халдейский оплот? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 26 )
	Talk( 18, "Ты хочешь отправиться в Андийский лес? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 26 )
	Talk( 19, "Ты хочешь отправиться в Гавань Оазиса? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 26 )
	Talk( 20, "Ты хочешь отправиться в Рощу акаций? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	Text( 20, "Переместиться",MultiTrigger, GetMultiTrigger(), 2 ) 
	Text( 20, CancelSelectTalk, JumpPage , CancelSelectPage )
	...
	TriggerFailure( 2, JumpPage, 26 )
	Talk( 21, "Ты хочешь отправиться в Пустошь Ледыни? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	Text( 21, "Переместиться",MultiTrigger, GetMultiTrigger(), 2 ) 
	Text( 21, CancelSelectTalk, JumpPage , CancelSelectPage )
	...
	TriggerFailure( 2, JumpPage, 26 )
	Talk( 22, "Ты хочешь отправиться в Бухту Атлантис? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 26 )
	Talk( 23, "Ты хочешь отправиться на Берег Скелетов? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerFailure( 2, JumpPage, 26 )
	Talk( 24, "Ты хочешь отправиться в Ледяной шип? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerAction( 2, GoTo, GoTo13X, GoTo13Y, GoTo13M )
	TriggerFailure( 2, JumpPage, 26 )
	Talk( 29, "Ты хочешь отправиться в Аргент? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	...
	TriggerAction( 2, GoTo, GoTo14X, GoTo14Y, GoTo14M )
	TriggerFailure( 2, JumpPage, 26 )
	Talk( 30, "Ты хочешь отправиться в Шайтан? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно.." )
	...
	TriggerAction( 2, GoTo, GoTo15X, GoTo15Y, GoTo15M )
	TriggerFailure( 2, JumpPage, 26 )
	Talk( 31, "Ты хочешь отправиться в Ледынь? Заплати мне 20000 золотых и я отправлю тебя туда. Для новичков, уровень которых ниже 40, это бесплатно." )
	Text( 31, "Переместиться",MultiTrigger, GetMultiTrigger(), 2)
	Text( 31, CancelSelectTalk, JumpPage , CancelSelectPage )
...
--	Text( 9, "Записать точку возрождения", JumpPage, 25 )
	...
	Talk( 14, "Ты хочешь отправиться на Остров Зефира? Нет проблем! Заплати мне 20000 золотых!" )
	...
	TriggerAction( 1, GoTo, GoTo02X, GoTo02Y, GoTo02M )
	TriggerFailure( 1, JumpPage, 26 )
	Talk( 15, "Ты хочешь отправиться на Ледниковый остров? Нет проблем! Заплати мне 20000 золотых!" )
	...
	TriggerAction( 1, GoTo, GoTo03X, GoTo03Y, GoTo03M )
	TriggerFailure( 1, JumpPage, 26 )
	Talk( 16, "Ты хочешь отправиться на Остров Отверженных? Нет проблем! Заплати мне 20000 золотых!" )
	...
	TriggerAction( 1, GoTo, GoTo04X, GoTo04Y, GoTo04M )
	TriggerFailure( 1, JumpPage, 26 )
	Talk( 17, "Ты хочешь отправиться на Остров Стужи? Нет проблем! Заплати мне 20000 золотых!" )
	...
	TriggerAction( 1, GoTo, GoTo05X, GoTo05Y, GoTo05M )
	TriggerFailure( 1, JumpPage, 26 )
	Talk( 18, "Ты хочешь отправиться на Остров Канареек? Нет проблем! Заплати мне 20000 золотых!" )
	...
	TriggerAction( 1, GoTo, GoTo06X, GoTo06Y, GoTo06M )
	TriggerFailure( 1, JumpPage, 26 )
	Talk( 19, "Ты хочешь отправиться на Остров Купидона? Нет проблем! Заплати мне 20000 золотых!" )
	...
	TriggerAction( 1, GoTo, GoTo07X, GoTo07Y, GoTo07M )
	TriggerFailure( 1, JumpPage, 26 )
	Talk( 20, "Ты хочешь отправиться на Остров Удачи? Нет проблем! Заплати мне 20000 золотых!" )
	...
	TriggerAction( 1, GoTo, GoTo08X, GoTo08Y, GoTo08M )
	TriggerFailure( 1, JumpPage, 26 )
	Talk( 21, "Ты хочешь отправиться в Аргент? Нет проблем! Заплати мне 80000 золотых!" )
...
--	TriggerAction( 2, TakeMoney, 20000 )
--	TriggerFailure( 1, JumpPage, 26 )
--	Talk( 29, "PKMap? No problem, just give me 20000 Gold, thank you!" )
