...
Text( 1, " Вторая профессия ", JumpPage, 3)
	Text(1, "Остановить опыт", )
	Text(1, "Возобновить опыт", )
...
Talk( 3, "Для получения требуется 40 лвл и 50к золота! " )
Text( 3, "Хочу быть Воителем!", JumpPage, 8 )
Text( 3, "Хочу быть Чемпионом!", JumpPage, 9 )
Text( 3, "Хочу быть Стрелком!", JumpPage, 10 )
Text( 3, "Хочу быть Целителем!", JumpPage, 11 )
Text( 3, "Хочу быть Ведьмой!", JumpPage, 12 )
Text( 3, "Хочу быть Покорителем Морей!", JumpPage, 13 )
Text( 3, "Пока", JumpPage, 1 )
...
Text( 4, "Перейти к выбору профессий ", JumpPage, 2 )
...
Text( 5, "Перейти к выбору профессий ", JumpPage, 2 )
...
Text( 6, "Перейти к выбору профессий ", JumpPage, 2 )
...
Text( 7, "Перейти к выбору профессий ", JumpPage, 2 )
...
Text( 8, "Перейти к выбору профессий", JumpPage, 2 )
...
Text( 9, "Перейти к выбору профессий ", JumpPage, 2 )
...
Text( 10, "Перейти к выбору профессий ", JumpPage, 2 )
...
Text( 11, "Перейти к выбору профессий ", JumpPage, 2 )
...
Text( 12, "Перейти к выбору профессий ", JumpPage, 2 )
...
Text( 13, "Перейти к выбору профессий ", JumpPage, 2 )
...
--[[	InitTrigger()
	...
	--Острова
	Weapon(	8605	)--Пропуск в Одинокую башню 6
	Weapon(	8606	)--Пропуск в Одинокую башню 6
	Weapon(	8607	)--Пропуск в Одинокую башню 6
	Weapon(	8608	)--Пропуск в Одинокую башню 6
	Weapon(	8609	)--Пропуск в Одинокую башню 6
	Weapon(	8610	)--Пропуск в Одинокую башню 6
	Weapon(	8611	)--Пропуск в Одинокую башню 6

	Weapon(	4604	)--Р‘РёР»РµС‚ РґРѕ Р›РµРґС‹РЅРё
	Weapon(	4603	)--Р‘РёР»РµС‚ РґРѕ РЁР°Р№С‚Р°РЅР°
	Weapon(	4602	)--Р‘РёР»РµС‚ РґРѕ РЎРµСЂРµР±СЂСЏРЅРѕРіРѕ
	Weapon(	3141	)--РћР±СЂР°С‚РЅС‹Р№ Р±РёР»РµС‚
	Weapon(	3076	)--РџСЂРѕРїСѓСЃРє РІ Р’РµСЃРЅРѕРіСЂР°Рґ
	Weapon(	3048	)--РџСЂРѕРїСѓСЃРє РІ Р“СЂРѕРјРѕРіСЂР°Рґ
	Weapon(	0563	)--РџСЂРѕРїСѓСЃРє РЅР° РѕСЃС‚СЂРѕРІ Р›РµС‚Р°
	Weapon(	0583	)--РџСЂРѕРїСѓСЃРє РЅР° РѕСЃС‚СЂРѕРІ РћСЃРµРЅРё
	Weapon(	3049	)--РЎР»РµРґСѓР№ РІ РїРѕСЂС‚ Р“СЂРѕРјРѕРіСЂР°РґР°
	Weapon(	3050	)--РџСЂРѕРїСѓСЃРє Рє РЎРІСЏС‰РµРЅРЅРѕР№ РЎРЅРµР¶РЅРѕР№ РіРѕСЂРµ
	Weapon(	3051	)--РџСЂРѕРїСѓСЃРє РІ РђРЅРґРёР№СЃРєРёР№ Р»РµСЃ
	Weapon(	3052	)--РџСЂРѕРїСѓСЃРє РІ РћР°Р·РёСЃ
	Weapon(	3053	)--РџСЂРѕРїСѓСЃРє Рє Р›РµРґСЏРЅРѕРјСѓ С€РёРїСѓ
	Weapon(	2445	)--Р‘РёР»РµС‚ РІ РєР°СЂРёР±СЃРєРѕРµ РїСѓС‚РµС€РµСЃС‚РІРёРµ
	Weapon(	3054	)--РџСЂРѕРїСѓСЃРє РІ РћРґРёРЅРѕРєСѓСЋ Р±Р°С€РЅСЋ
	Weapon(	3059	)--Р‘РёР»РµС‚ РІ РћРґРёРЅРѕРєСѓСЋ Р±Р°С€РЅСЋ 2
	Weapon(	3060	)--РџСЂРѕРїСѓСЃРє РІ РћРґРёРЅРѕРєСѓСЋ Р±Р°С€РЅСЋ 3
	Weapon(	3070	)--РџСЂРѕРїСѓСЃРє РІ РћРґРёРЅРѕРєСѓСЋ Р±Р°С€РЅСЋ 4
	Weapon(	3071	)--РџСЂРѕРїСѓСЃРє РІ РћРґРёРЅРѕРєСѓСЋ Р±Р°С€РЅСЋ 5
	Weapon(	3072	)--РџСЂРѕРїСѓСЃРє РІ РћРґРёРЅРѕРєСѓСЋ Р±Р°С€РЅСЋ 6
	--РћСЃС‚СЂРѕРІР°
	Weapon(	6514	)--РџСЂРѕРїСѓСЃРє РІ РћРґРёРЅРѕРєСѓСЋ Р±Р°С€РЅСЋ 6
	Weapon(	6515	)--РџСЂРѕРїСѓСЃРє РІ РћРґРёРЅРѕРєСѓСЋ Р±Р°С€РЅСЋ 6
	Weapon(	6516	)--РџСЂРѕРїСѓСЃРє РІ РћРґРёРЅРѕРєСѓСЋ Р±Р°С€РЅСЋ 6
	Weapon(	6517	)--РџСЂРѕРїСѓСЃРє РІ РћРґРёРЅРѕРєСѓСЋ Р±Р°С€РЅСЋ 6
	Weapon(	6518	)--РџСЂРѕРїСѓСЃРє РІ РћРґРёРЅРѕРєСѓСЋ Р±Р°С€РЅСЋ 6
	Weapon(	6519	)--РџСЂРѕРїСѓСЃРє РІ РћРґРёРЅРѕРєСѓСЋ Р±Р°С€РЅСЋ 6
	Weapon(	6520	)--РџСЂРѕРїСѓСЃРє РІ РћРґРёРЅРѕРєСѓСЋ Р±Р°С€РЅСЋ 6
