...
-- Гавани для кораблей
AddBerthPort(1,"Порт Аргента")
AddBerthPort(2,"Порт Громограда")
AddBerthPort(3,"Порт Шайтана")
AddBerthPort(4,"Порт Ледыни")
AddBerthPort(5,"Порт о. Зефира")
AddBerthPort(6,"Порт Ледникового острова")
AddBerthPort(7,"Порт о. Отверженных")
AddBerthPort(8,"Порт о. Стужи")
AddBerthPort(9,"Порт о. Канареек")
AddBerthPort(10,"Порт о. Купидона")
AddBerthPort(11,"Порт о. Удачи")
AddBerthPort(12,"Таинственный порт")
AddBerthPort(13,"Порт о. Весны")
AddBerthPort(14,"Северный порт о. Лета")
AddBerthPort(15,"Южный порт о. Лета")
