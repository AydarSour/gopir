...
function Add_Item_Attr(attr_idx, radio) --¼ò»¯²Ù×÷, Îªitem_addÌí¼ÓÒ»ÖÖÊôÐÔ
   ...
   item_add.attr[item_add.cnt] = { attr_idx, radio }
	...
	Mxhp_con_rad2 = {} 
	Mxhp_lv_rad = {}  
	Mxhp_bs = {}   		--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
	Mxsp_sta_rad1 = {}  
	Mxsp_sta_rad2 = {} 
	Mxsp_lv_rad = {}   		--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
	Mnatk_str_rad1 = {} 
	Mnatk_str_rad2 = {} 
	Mnatk_dex_rad1 = {}   
	Mnatk_dex_rad2 = {}	--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý¡¢×¨×¢ÏµÊý
	Mxatk_str_rad1 = {} 
	Mxatk_str_rad2 = {} 
	Mxatk_dex_rad1 = {}   
	Mxatk_dex_rad2 = {}	  --×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý¡¢×¨×¢ÏµÊý
	Def_con_rad1 = {}   	
	Def_con_rad2 = {}	--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
	Hit_dex_rad1 = {}  
	Hit_dex_rad2 = {} 
	Hit_lv_rad = {}  
	Hit_min = {}   		--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
	Flee_agi_rad1 = {} 
	Flee_agi_rad2 = {} 
	Flee_lv_rad = {}  
	Flee_min = {}   		--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--	Mf_luk_rad = {}   	--±©ÁÏÂÊµÄÊôÐÔÓ°ÏìÏµÊý£ºÐÒÔËÏµÊý
--	Crt_luk_rad = {}  
	Crt_min = {}  
	Crt_max = {}   		--±©»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÐÒÔËÏµÊý¡¢×îÐ¡±©»÷ÂÊ¡¢×î´ó±©»÷ÂÊ
	Hrec_bsmxhp_rad = {}  
	Hrec_con_rad = {}  
	Hrec_min = {}   		--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
	Srec_bsmxsp_rad = {}  
	Srec_sta_rad = {}  
	Srec_min = {}   		--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
	Aspd_bsrad = {}  
	Aspd_agi_rad = {}  
	Aspd_min = {}    		--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ				--
	Str_updata = {} 
	Dex_updata = {} 
	Con_updata = {} 
	Agi_updata = {} 
...
--ÐÂÊÖÖ°ÒµÊôÐÔ³É³¤±ÈÂÊ 
		Mxhp_con_rad1[JOB_TYPE_XINSHOU], Mxhp_con_rad2[JOB_TYPE_XINSHOU], Mxhp_lv_rad[JOB_TYPE_XINSHOU]	=	3	,	2	,	15							--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_XINSHOU], Mxsp_sta_rad2[JOB_TYPE_XINSHOU], Mxsp_lv_rad[JOB_TYPE_XINSHOU]	=	1	,	0	,	3 						--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_XINSHOU], Mnatk_str_rad2[JOB_TYPE_XINSHOU], Mnatk_dex_rad1[JOB_TYPE_XINSHOU], Mnatk_dex_rad2[JOB_TYPE_XINSHOU]	=	1.5	,	0.4	,	0	,	0						--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_XINSHOU], Mxatk_str_rad2[JOB_TYPE_XINSHOU], Mxatk_dex_rad1[JOB_TYPE_XINSHOU], Mxatk_dex_rad2[JOB_TYPE_XINSHOU]	=	1.5	,	0.4	,	0	,	0						--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_XINSHOU], Def_con_rad2[JOB_TYPE_XINSHOU]		=	0.1		,	0.1 											--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_XINSHOU], Hit_dex_rad2[JOB_TYPE_XINSHOU]		=	0.6		,	0 										--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_XINSHOU], Flee_agi_rad2[JOB_TYPE_XINSHOU]		=	0.6		,	0									--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_XINSHOU]		= 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_XINSHOU]		= 0.31	--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_XINSHOU], Hrec_con_rad[JOB_TYPE_XINSHOU]	=	1/200	,	1/8									--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_XINSHOU], Srec_sta_rad[JOB_TYPE_XINSHOU]	=	1/100	,	1/12									--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_XINSHOU]	=	1.1    															--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ				--
...
--½£Ê¿Ö°ÒµÊôÐÔ³É³¤±ÈÂÊ 
		...
		Mxhp_con_rad1[JOB_TYPE_JIANSHI], Mxhp_con_rad2[JOB_TYPE_JIANSHI], Mxhp_lv_rad[JOB_TYPE_JIANSHI] =	5	,	7	,	25							--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_JIANSHI], Mxsp_sta_rad2[JOB_TYPE_JIANSHI], Mxsp_lv_rad[JOB_TYPE_JIANSHI] = 1	, 0	, 3							--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_JIANSHI], Mnatk_str_rad2[JOB_TYPE_JIANSHI], Mnatk_dex_rad1[JOB_TYPE_JIANSHI], Mnatk_dex_rad2[JOB_TYPE_JIANSHI] =	1.5	,	0.4	,	0	,	0   		--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_JIANSHI], Mxatk_str_rad2[JOB_TYPE_JIANSHI], Mxatk_dex_rad1[JOB_TYPE_JIANSHI], Mxatk_dex_rad2[JOB_TYPE_JIANSHI] = 	1.5	,	0.4	,	0	,	0    		--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_JIANSHI], Def_con_rad2[JOB_TYPE_JIANSHI] =		0.2	,	0.2	 										--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_JIANSHI], Hit_dex_rad2[JOB_TYPE_JIANSHI] =		0.6	,	0										--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_JIANSHI], Flee_agi_rad2[JOB_TYPE_JIANSHI] =		0.6	,	0										--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_JIANSHI] = 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_JIANSHI] = 0.31		--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_JIANSHI], Hrec_con_rad[JOB_TYPE_JIANSHI] = 1/180, 1/8									--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_JIANSHI], Srec_sta_rad[JOB_TYPE_JIANSHI] = 1/100, 1/12 									--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_JIANSHI] =	1.1   														--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ				
...
--ÁÔÈËÖ°ÒµÊôÐÔ³É³¤±ÈÂÊ 
		...
		Mxhp_con_rad1[JOB_TYPE_LIEREN], Mxhp_con_rad2[JOB_TYPE_LIEREN], Mxhp_lv_rad[JOB_TYPE_LIEREN] =	3	, 3	, 25 							--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_LIEREN], Mxsp_sta_rad2[JOB_TYPE_LIEREN], Mxsp_lv_rad[JOB_TYPE_LIEREN] =		1	,	0	, 3							--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_LIEREN], Mnatk_str_rad2[JOB_TYPE_LIEREN], Mnatk_dex_rad1[JOB_TYPE_LIEREN], Mnatk_dex_rad2[JOB_TYPE_LIEREN] = 0, 0, 1.7, 0.4 		--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_LIEREN], Mxatk_str_rad2[JOB_TYPE_LIEREN], Mxatk_dex_rad1[JOB_TYPE_LIEREN], Mxatk_dex_rad2[JOB_TYPE_LIEREN] = 0, 0, 1.7, 0.4 		--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_LIEREN], Def_con_rad2[JOB_TYPE_LIEREN] =	0.14,	0.1 										--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_LIEREN], Hit_dex_rad2[JOB_TYPE_LIEREN] =	0.7	,	0										--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_LIEREN], Flee_agi_rad2[JOB_TYPE_LIEREN] =	0.7	,	0										--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_LIEREN] = 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_LIEREN] = 0.25		--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_LIEREN], Hrec_con_rad[JOB_TYPE_LIEREN] = 1/180, 1/8 									--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_LIEREN], Srec_sta_rad[JOB_TYPE_LIEREN] = 1/100, 1/12 										--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_LIEREN] =	1.2   												 			--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ				--
...
--Ë®ÊÖÖ°ÒµÊôÐÔ³É³¤±ÈÂÊ 
		Mxhp_con_rad1[JOB_TYPE_SHUISHOU], Mxhp_con_rad2[JOB_TYPE_SHUISHOU], Mxhp_lv_rad[JOB_TYPE_SHUISHOU] = 3, 2, 15							--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_SHUISHOU], Mxsp_sta_rad2[JOB_TYPE_SHUISHOU], Mxsp_lv_rad[JOB_TYPE_SHUISHOU] = 0.5, 0.5, 1						--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_SHUISHOU], Mnatk_str_rad2[JOB_TYPE_SHUISHOU], Mnatk_dex_rad1[JOB_TYPE_SHUISHOU], Mnatk_dex_rad2[JOB_TYPE_SHUISHOU] = 0.9, 0.9, 0, 0						--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_SHUISHOU], Mxatk_str_rad2[JOB_TYPE_SHUISHOU], Mxatk_dex_rad1[JOB_TYPE_SHUISHOU], Mxatk_dex_rad2[JOB_TYPE_SHUISHOU] = 0.9, 0.9, 0, 0 						--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_SHUISHOU], Def_con_rad2[JOB_TYPE_SHUISHOU] = 0.45, 0.45 											--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_SHUISHOU], Hit_dex_rad2[JOB_TYPE_SHUISHOU] = 0.31, 0.15 										--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_SHUISHOU], Flee_agi_rad2[JOB_TYPE_SHUISHOU] = 0.31, 0.15									--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_SHUISHOU] = 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_SHUISHOU] = 0.31	--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_SHUISHOU], Hrec_con_rad[JOB_TYPE_SHUISHOU] = 1/200, 1/100									--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_SHUISHOU], Srec_sta_rad[JOB_TYPE_SHUISHOU] = 1/200, 1/120									--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_SHUISHOU] = 1.1   															--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ				--
...
--Ã°ÏÕÕßÖ°ÒµÊôÐÔ³É³¤±ÈÂÊ 

		Mxhp_con_rad1[JOB_TYPE_MAOXIANZHE], Mxhp_con_rad2[JOB_TYPE_MAOXIANZHE], Mxhp_lv_rad[JOB_TYPE_MAOXIANZHE] =	5	,	5	, 25						--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_MAOXIANZHE], Mxsp_sta_rad2[JOB_TYPE_MAOXIANZHE], Mxsp_lv_rad[JOB_TYPE_MAOXIANZHE] =	2	,	1.5	, 5							--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_MAOXIANZHE], Mnatk_str_rad2[JOB_TYPE_MAOXIANZHE], Mnatk_dex_rad1[JOB_TYPE_MAOXIANZHE], Mnatk_dex_rad2[JOB_TYPE_MAOXIANZHE] = 1.5,	0.4,		0,	0					--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_MAOXIANZHE], Mxatk_str_rad2[JOB_TYPE_MAOXIANZHE], Mxatk_dex_rad1[JOB_TYPE_MAOXIANZHE], Mxatk_dex_rad2[JOB_TYPE_MAOXIANZHE] = 1.5,	0.4,		0,	0 					--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_MAOXIANZHE], Def_con_rad2[JOB_TYPE_MAOXIANZHE] = 0.13	,	0.1 										--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_MAOXIANZHE], Hit_dex_rad2[JOB_TYPE_MAOXIANZHE] =		0.6,		0 									--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_MAOXIANZHE], Flee_agi_rad2[JOB_TYPE_MAOXIANZHE] =	0.6,		0									--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_MAOXIANZHE] = 0.39 														--±©ÁÏÂÊµÄÊôÐÔÓ°ÏìÏµÊý£ºÐÒÔËÏµÊý
--		Crt_luk_rad[JOB_TYPE_MAOXIANZHE] = 0.31	--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_MAOXIANZHE], Hrec_con_rad[JOB_TYPE_MAOXIANZHE] = 1/180, 1/8								--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_MAOXIANZHE], Srec_sta_rad[JOB_TYPE_MAOXIANZHE] = 1/100, 1/12								--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_MAOXIANZHE]	=	1.1   												 		--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ			
...
--Ò©Ê¦Ö°ÒµÊôÐÔ³É³¤±ÈÂÊ 
		...
		Mxhp_con_rad1[JOB_TYPE_QIYUANSHI], Mxhp_con_rad2[JOB_TYPE_QIYUANSHI], Mxhp_lv_rad[JOB_TYPE_QIYUANSHI] =	5	,	5	, 25						--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_QIYUANSHI], Mxsp_sta_rad2[JOB_TYPE_QIYUANSHI], Mxsp_lv_rad[JOB_TYPE_QIYUANSHI] =	2	,	1.5	, 5							--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_QIYUANSHI], Mnatk_str_rad2[JOB_TYPE_QIYUANSHI], Mnatk_dex_rad1[JOB_TYPE_QIYUANSHI], Mnatk_dex_rad2[JOB_TYPE_QIYUANSHI] = 1.5,	0.4,		0,	0					--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_QIYUANSHI], Mxatk_str_rad2[JOB_TYPE_QIYUANSHI], Mxatk_dex_rad1[JOB_TYPE_QIYUANSHI], Mxatk_dex_rad2[JOB_TYPE_QIYUANSHI] = 1.5,	0.4,		0,	0 					--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_QIYUANSHI], Def_con_rad2[JOB_TYPE_QIYUANSHI] = 0.13	,	0.1 										--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_QIYUANSHI], Hit_dex_rad2[JOB_TYPE_QIYUANSHI] =		0.6,		0 									--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_QIYUANSHI], Flee_agi_rad2[JOB_TYPE_QIYUANSHI] = 0.6,	0										--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_QIYUANSHI] = 0.39 														--±©ÁÏÂÊµÄÊôÐÔÓ°ÏìÏµÊý£ºÐÒÔËÏµÊý
--		Crt_luk_rad[JOB_TYPE_QIYUANSHI] = 0.31	--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_QIYUANSHI], Hrec_con_rad[JOB_TYPE_QIYUANSHI] = 1/180, 1/8								--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_QIYUANSHI], Srec_sta_rad[JOB_TYPE_QIYUANSHI] = 1/100, 1/12								--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_QIYUANSHI]	=	1.1   												 		--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ			
...
--¼¼Ê¦Ö°ÒµÊôÐÔ³É³¤±ÈÂÊ 
		...
		Mxhp_con_rad1[JOB_TYPE_JISHI], Mxhp_con_rad2[JOB_TYPE_JISHI], Mxhp_lv_rad[JOB_TYPE_JISHI] = 2, 2, 10 						--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_JISHI], Mxsp_sta_rad2[JOB_TYPE_JISHI], Mxsp_lv_rad[JOB_TYPE_JISHI] = 0.5, 0.5, 1					--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_JISHI], Mnatk_str_rad2[JOB_TYPE_JISHI], Mnatk_dex_rad1[JOB_TYPE_JISHI], Mnatk_dex_rad2[JOB_TYPE_JISHI] = 0.8, 0.8, 0, 0				--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_JISHI], Mxatk_str_rad2[JOB_TYPE_JISHI], Mxatk_dex_rad1[JOB_TYPE_JISHI], Mxatk_dex_rad2[JOB_TYPE_JISHI] = 0.8, 0.8, 0, 0 					--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_JISHI], Def_con_rad2[JOB_TYPE_JISHI] = 0.5, 0.5 										--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_JISHI], Hit_dex_rad2[JOB_TYPE_JISHI] = 0.31, 0.15 									--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_JISHI], Flee_agi_rad2[JOB_TYPE_JISHI] = 0.31, 0.15								--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_JISHI] = 0.39 														--±©ÁÏÂÊµÄÊôÐÔÓ°ÏìÏµÊý£ºÐÒÔËÏµÊý
--		Crt_luk_rad[JOB_TYPE_JISHI] = 0.31													--±©»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÐÒÔËÏµÊý¡¢×îÐ¡±©»÷ÂÊ¡¢×î´ó±©»÷ÂÊ
		Hrec_bsmxhp_rad[JOB_TYPE_JISHI], Hrec_con_rad[JOB_TYPE_JISHI] = 1/200, 1/100								--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_JISHI],Srec_sta_rad[JOB_TYPE_JISHI] = 1/200, 1/120									--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_JISHI] = 1.1   												 		--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ			
...
--ÉÌÈËÖ°ÒµÊôÐÔ³É³¤±ÈÂÊ¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª 

		Mxhp_con_rad1[JOB_TYPE_SHANGREN], Mxhp_con_rad2[JOB_TYPE_SHANGREN], Mxhp_lv_rad[JOB_TYPE_SHANGREN] = 2, 2, 10 						--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_SHANGREN], Mxsp_sta_rad2[JOB_TYPE_SHANGREN], Mxsp_lv_rad[JOB_TYPE_SHANGREN] = 0.5, 0.5, 1						--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_SHANGREN], Mnatk_str_rad2[JOB_TYPE_SHANGREN], Mnatk_dex_rad1[JOB_TYPE_SHANGREN], Mnatk_dex_rad2[JOB_TYPE_SHANGREN] = 0.8, 0.8, 0, 0					--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_SHANGREN], Mxatk_str_rad2[JOB_TYPE_SHANGREN], Mxatk_dex_rad1[JOB_TYPE_SHANGREN], Mxatk_dex_rad2[JOB_TYPE_SHANGREN] = 0.8, 0.8, 0, 0 					--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_SHANGREN], Def_con_rad2[JOB_TYPE_SHANGREN] = 0.5, 0.5 									--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_SHANGREN], Hit_dex_rad2[JOB_TYPE_SHANGREN] = 0.31, 0.15 									--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_SHANGREN], Flee_agi_rad2[JOB_TYPE_SHANGREN] = 0.31, 0.15									--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_SHANGREN] = 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_SHANGREN] = 0.31	--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_SHANGREN], Hrec_con_rad[JOB_TYPE_SHANGREN] = 1/200, 1/100								--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_SHANGREN], Srec_sta_rad[JOB_TYPE_SHANGREN] = 1/200, 1/120									--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_SHANGREN] = 1.1   												 		--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ			
...
-- ¾Þ½£Ê¿Ö°ÒµÊôÐÔ³É³¤±ÈÂÊ¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª

		Mxhp_con_rad1[JOB_TYPE_JUJS], Mxhp_con_rad2[JOB_TYPE_JUJS], Mxhp_lv_rad[JOB_TYPE_JUJS] = 5,7,40 						--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_JUJS], Mxsp_sta_rad2[JOB_TYPE_JUJS], Mxsp_lv_rad[JOB_TYPE_JUJS] = 1,0,3 						--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_JUJS], Mnatk_str_rad2[JOB_TYPE_JUJS], Mnatk_dex_rad1[JOB_TYPE_JUJS], Mnatk_dex_rad2[JOB_TYPE_JUJS] = 2,0.45, 0, 0					--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_JUJS], Mxatk_str_rad2[JOB_TYPE_JUJS], Mxatk_dex_rad1[JOB_TYPE_JUJS], Mxatk_dex_rad2[JOB_TYPE_JUJS] =  2,0.45, 0, 0					--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_JUJS], Def_con_rad2[JOB_TYPE_JUJS] = 0.2,0.6 									--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_JUJS], Hit_dex_rad2[JOB_TYPE_JUJS] = 0.6, 0.2 									--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_JUJS], Flee_agi_rad2[JOB_TYPE_JUJS] = 0.6, 0.2									--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_JUJS] = 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_JUJS] = 0.31	--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_JUJS], Hrec_con_rad[JOB_TYPE_JUJS] = 1/180, 1/8								--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_JUJS], Srec_sta_rad[JOB_TYPE_JUJS] = 1/100, 1/12									--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_JUJS] = 1.1    												 		--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ			
...
--		Mf_luk_rad[JOB_TYPE_SHUANGJS] = 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_SHUANGJS] = 0.31	--Íåíóæíûé ïàðàìåòð
...
--½£¶ÜÊ¿Ö°ÒµÊôÐÔ³É³¤±ÈÂÊ¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª 

		Mxhp_con_rad1[JOB_TYPE_JIANDUNSHI], Mxhp_con_rad2[JOB_TYPE_JIANDUNSHI], Mxhp_lv_rad[JOB_TYPE_JIANDUNSHI] = 2, 2, 10 						--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_JIANDUNSHI], Mxsp_sta_rad2[JOB_TYPE_JIANDUNSHI], Mxsp_lv_rad[JOB_TYPE_JIANDUNSHI] = 0.5, 0.5, 1						--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_JIANDUNSHI], Mnatk_str_rad2[JOB_TYPE_JIANDUNSHI], Mnatk_dex_rad1[JOB_TYPE_JIANDUNSHI], Mnatk_dex_rad2[JOB_TYPE_JIANDUNSHI] = 0.8, 0.8, 0, 0					--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_JIANDUNSHI], Mxatk_str_rad2[JOB_TYPE_JIANDUNSHI], Mxatk_dex_rad1[JOB_TYPE_JIANDUNSHI], Mxatk_dex_rad2[JOB_TYPE_JIANDUNSHI] = 0.8, 0.8, 0, 0 					--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_JIANDUNSHI], Def_con_rad2[JOB_TYPE_JIANDUNSHI] = 0.5, 0.5 									--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_JIANDUNSHI], Hit_dex_rad2[JOB_TYPE_JIANDUNSHI] = 0.31, 0.15 									--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_JIANDUNSHI], Flee_agi_rad2[JOB_TYPE_JIANDUNSHI] = 0.31, 0.15									--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_JIANDUNSHI] = 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_JIANDUNSHI] = 0.31	--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_JIANDUNSHI], Hrec_con_rad[JOB_TYPE_JIANDUNSHI] = 1/200, 1/100								--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_JIANDUNSHI], Srec_sta_rad[JOB_TYPE_JIANDUNSHI] = 1/200, 1/120									--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_JIANDUNSHI] = 1.1   												 		--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ			
...
--Ñ±ÊÞÊ¦Ö°ÒµÊôÐÔ³É³¤±ÈÂÊ¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª 

		Mxhp_con_rad1[JOB_TYPE_XUNSHOUSHI], Mxhp_con_rad2[JOB_TYPE_XUNSHOUSHI], Mxhp_lv_rad[JOB_TYPE_XUNSHOUSHI] = 2, 2, 10 						--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_XUNSHOUSHI], Mxsp_sta_rad2[JOB_TYPE_XUNSHOUSHI], Mxsp_lv_rad[JOB_TYPE_XUNSHOUSHI] = 0.5, 0.5, 1						--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_XUNSHOUSHI], Mnatk_str_rad2[JOB_TYPE_XUNSHOUSHI], Mnatk_dex_rad1[JOB_TYPE_XUNSHOUSHI], Mnatk_dex_rad2[JOB_TYPE_XUNSHOUSHI] = 0.8, 0.8, 0, 0					--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_XUNSHOUSHI], Mxatk_str_rad2[JOB_TYPE_XUNSHOUSHI], Mxatk_dex_rad1[JOB_TYPE_XUNSHOUSHI], Mxatk_dex_rad2[JOB_TYPE_XUNSHOUSHI] = 0.8, 0.8, 0, 0 					--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_XUNSHOUSHI], Def_con_rad2[JOB_TYPE_XUNSHOUSHI] = 0.5, 0.5 									--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_XUNSHOUSHI], Hit_dex_rad2[JOB_TYPE_XUNSHOUSHI] = 0.31, 0.15 									--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_XUNSHOUSHI], Flee_agi_rad2[JOB_TYPE_XUNSHOUSHI] = 0.31, 0.15									--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_XUNSHOUSHI] = 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_XUNSHOUSHI] = 0.31	--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_XUNSHOUSHI], Hrec_con_rad[JOB_TYPE_XUNSHOUSHI] = 1/200, 1/100								--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_XUNSHOUSHI], Srec_sta_rad[JOB_TYPE_XUNSHOUSHI] = 1/200, 1/120									--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_XUNSHOUSHI] = 1.2   												 		--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ			
...
--		Mf_luk_rad[JOB_TYPE_JUJISHOU] = 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_JUJISHOU] = 0.31	--Íåíóæíûé ïàðàìåòð
...
--Ê¥Ö°ÕßÊôÐÔ³É³¤±ÈÂÊ¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª 

		Mxhp_con_rad1[JOB_TYPE_SHENGZHIZHE], Mxhp_con_rad2[JOB_TYPE_SHENGZHIZHE], Mxhp_lv_rad[JOB_TYPE_SHENGZHIZHE] = 	5	,	5	, 30					--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_SHENGZHIZHE], Mxsp_sta_rad2[JOB_TYPE_SHENGZHIZHE], Mxsp_lv_rad[JOB_TYPE_SHENGZHIZHE] = 		3	,	1.5	, 5					--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_SHENGZHIZHE], Mnatk_str_rad2[JOB_TYPE_SHENGZHIZHE], Mnatk_dex_rad1[JOB_TYPE_SHENGZHIZHE], Mnatk_dex_rad2[JOB_TYPE_SHENGZHIZHE] = 1.5,	0.4,		0,	0				--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_SHENGZHIZHE], Mxatk_str_rad2[JOB_TYPE_SHENGZHIZHE], Mxatk_dex_rad1[JOB_TYPE_SHENGZHIZHE], Mxatk_dex_rad2[JOB_TYPE_SHENGZHIZHE] = 1.5,	0.4,		0,	0				--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_SHENGZHIZHE], Def_con_rad2[JOB_TYPE_SHENGZHIZHE] =	0.15	,	0.1 									--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_SHENGZHIZHE], Hit_dex_rad2[JOB_TYPE_SHENGZHIZHE] = 			0.6,		0 							--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_SHENGZHIZHE], Flee_agi_rad2[JOB_TYPE_SHENGZHIZHE] = 	0.6,		0									--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_SHENGZHIZHE] = 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_SHENGZHIZHE] = 0.31	--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_SHENGZHIZHE], Hrec_con_rad[JOB_TYPE_SHENGZHIZHE] = 1/180, 1/8								--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_SHENGZHIZHE], Srec_sta_rad[JOB_TYPE_SHENGZHIZHE] = 1/100, 1/12									--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_SHENGZHIZHE] = 1.1   												 		--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ			
...
--·âÓ¡Ê¦Ö°ÒµÊôÐÔ³É³¤±ÈÂÊ¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª 

		Mxhp_con_rad1[JOB_TYPE_FENGYINSHI], Mxhp_con_rad2[JOB_TYPE_FENGYINSHI], Mxhp_lv_rad[JOB_TYPE_FENGYINSHI] = 	5	,	5	, 30						--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_FENGYINSHI], Mxsp_sta_rad2[JOB_TYPE_FENGYINSHI], Mxsp_lv_rad[JOB_TYPE_FENGYINSHI] = 		3	,	1.5	, 5						--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_FENGYINSHI], Mnatk_str_rad2[JOB_TYPE_FENGYINSHI], Mnatk_dex_rad1[JOB_TYPE_FENGYINSHI], Mnatk_dex_rad2[JOB_TYPE_FENGYINSHI] = 1.5,	0.4,		0,	0						--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_FENGYINSHI], Mxatk_str_rad2[JOB_TYPE_FENGYINSHI], Mxatk_dex_rad1[JOB_TYPE_FENGYINSHI], Mxatk_dex_rad2[JOB_TYPE_FENGYINSHI] = 1.5,	0.4,		0,	0					--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_FENGYINSHI], Def_con_rad2[JOB_TYPE_FENGYINSHI] = 		0.15	,	0.1 									--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_FENGYINSHI], Hit_dex_rad2[JOB_TYPE_FENGYINSHI] =  			0.6,		0 									--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_FENGYINSHI], Flee_agi_rad2[JOB_TYPE_FENGYINSHI] =		0.6,		0									--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_FENGYINSHI] = 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_FENGYINSHI] = 0.31	--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_FENGYINSHI], Hrec_con_rad[JOB_TYPE_FENGYINSHI] = 1/180, 1/8									--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_FENGYINSHI], Srec_sta_rad[JOB_TYPE_FENGYINSHI] = 1/100, 1/12									--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_FENGYINSHI] = 1.1 												 		--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ			
...
--´¬³¤Ö°ÒµÊôÐÔ³É³¤±ÈÂÊ¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª 

		Mxhp_con_rad1[JOB_TYPE_CHUANZHANG], Mxhp_con_rad2[JOB_TYPE_CHUANZHANG], Mxhp_lv_rad[JOB_TYPE_CHUANZHANG] = 2, 2, 10 						--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_CHUANZHANG], Mxsp_sta_rad2[JOB_TYPE_CHUANZHANG], Mxsp_lv_rad[JOB_TYPE_CHUANZHANG] = 0.5, 0.5, 1						--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_CHUANZHANG], Mnatk_str_rad2[JOB_TYPE_CHUANZHANG], Mnatk_dex_rad1[JOB_TYPE_CHUANZHANG], Mnatk_dex_rad2[JOB_TYPE_CHUANZHANG] = 0.8, 0.8, 0, 0					--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_CHUANZHANG], Mxatk_str_rad2[JOB_TYPE_CHUANZHANG], Mxatk_dex_rad1[JOB_TYPE_CHUANZHANG], Mxatk_dex_rad2[JOB_TYPE_CHUANZHANG] = 0.8, 0.8, 0, 0 					--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_CHUANZHANG], Def_con_rad2[JOB_TYPE_CHUANZHANG] = 0.5, 0.5 									--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_CHUANZHANG], Hit_dex_rad2[JOB_TYPE_CHUANZHANG] = 0.31, 0.15 									--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_CHUANZHANG], Flee_agi_rad2[JOB_TYPE_CHUANZHANG] = 0.31, 0.15									--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_CHUANZHANG] = 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_CHUANZHANG] = 0.31	--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_CHUANZHANG], Hrec_con_rad[JOB_TYPE_CHUANZHANG] = 1/200, 1/100								--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_CHUANZHANG], Srec_sta_rad[JOB_TYPE_CHUANZHANG] = 1/200, 1/120									--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_CHUANZHANG] = 1.1   												 		--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ			
...
--º½º£Ê¿Ö°ÒµÊôÐÔ³É³¤±ÈÂÊ¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª 

		Mxhp_con_rad1[JOB_TYPE_HANGHAISHI], Mxhp_con_rad2[JOB_TYPE_HANGHAISHI], Mxhp_lv_rad[JOB_TYPE_HANGHAISHI] = 	5	,	5	, 30						--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_HANGHAISHI], Mxsp_sta_rad2[JOB_TYPE_HANGHAISHI], Mxsp_lv_rad[JOB_TYPE_HANGHAISHI] = 		3	,	1.5	, 5					--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_HANGHAISHI], Mnatk_str_rad2[JOB_TYPE_HANGHAISHI], Mnatk_dex_rad1[JOB_TYPE_HANGHAISHI], Mnatk_dex_rad2[JOB_TYPE_HANGHAISHI] = 1.5,	0.4,		0,	0				--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_HANGHAISHI], Mxatk_str_rad2[JOB_TYPE_HANGHAISHI], Mxatk_dex_rad1[JOB_TYPE_HANGHAISHI], Mxatk_dex_rad2[JOB_TYPE_HANGHAISHI] = 1.5,	0.4,		0,	0				--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_HANGHAISHI], Def_con_rad2[JOB_TYPE_HANGHAISHI] =  		0.15	,	0.1 									--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_HANGHAISHI], Hit_dex_rad2[JOB_TYPE_HANGHAISHI] = 			0.6,		0 								--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_HANGHAISHI], Flee_agi_rad2[JOB_TYPE_HANGHAISHI] = 		0.6,		0									--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_HANGHAISHI] = 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_HANGHAISHI] = 0.31	--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_HANGHAISHI], Hrec_con_rad[JOB_TYPE_HANGHAISHI] = 1/180, 1/8								--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_HANGHAISHI], Srec_sta_rad[JOB_TYPE_HANGHAISHI] = 1/100, 1/12									--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_HANGHAISHI] = 1.1   												 		--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ			
...
--±¬·¢»§Ö°ÒµÊôÐÔ³É³¤±ÈÂÊ¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª 
		...
		Mxhp_con_rad1[JOB_TYPE_BAOFAHU], Mxhp_con_rad2[JOB_TYPE_BAOFAHU], Mxhp_lv_rad[JOB_TYPE_BAOFAHU] = 2, 2, 10 						--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_BAOFAHU], Mxsp_sta_rad2[JOB_TYPE_BAOFAHU], Mxsp_lv_rad[JOB_TYPE_BAOFAHU] = 0.5, 0.5, 1						--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_BAOFAHU], Mnatk_str_rad2[JOB_TYPE_BAOFAHU], Mnatk_dex_rad1[JOB_TYPE_BAOFAHU], Mnatk_dex_rad2[JOB_TYPE_BAOFAHU] = 0.8, 0.8, 0, 0					--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_BAOFAHU], Mxatk_str_rad2[JOB_TYPE_BAOFAHU], Mxatk_dex_rad1[JOB_TYPE_BAOFAHU], Mxatk_dex_rad2[JOB_TYPE_BAOFAHU] = 0.8, 0.8, 0, 0 					--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_BAOFAHU], Def_con_rad2[JOB_TYPE_BAOFAHU] = 0.5, 0.5 									--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_BAOFAHU], Hit_dex_rad2[JOB_TYPE_BAOFAHU] = 0.31, 0.15 									--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_BAOFAHU], Flee_agi_rad2[JOB_TYPE_BAOFAHU] = 0.31, 0.15									--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_BAOFAHU] = 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_BAOFAHU] = 0.31	--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_BAOFAHU], Hrec_con_rad[JOB_TYPE_BAOFAHU] = 1/200, 1/100								--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_BAOFAHU], Srec_sta_rad[JOB_TYPE_BAOFAHU] = 1/200, 1/120									--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_BAOFAHU]	=	1.1   												 		--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ			
...
--¹¤³ÌÊ¦Ö°ÒµÊôÐÔ³É³¤±ÈÂÊ¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª 

		Mxhp_con_rad1[JOB_TYPE_GONGCHENGSHI], Mxhp_con_rad2[JOB_TYPE_GONGCHENGSHI], Mxhp_lv_rad[JOB_TYPE_GONGCHENGSHI] = 2, 2, 10 						--×î´óhpµÄÊôÐÔÓ°ÏìÏµÊý£ºÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý¡¢»ù±¾Êý
		Mxsp_sta_rad1[JOB_TYPE_GONGCHENGSHI], Mxsp_sta_rad2[JOB_TYPE_GONGCHENGSHI], Mxsp_lv_rad[JOB_TYPE_GONGCHENGSHI] = 0.5, 0.5, 1						--×î´óspµÄÊôÐÔÓ°ÏìÏµÊý£º¾«Á¦ÏµÊý¡¢ÌåÖÊÏµÊý¡¢µÈ¼¶ÏµÊý
		Mnatk_str_rad1[JOB_TYPE_GONGCHENGSHI], Mnatk_str_rad2[JOB_TYPE_GONGCHENGSHI], Mnatk_dex_rad1[JOB_TYPE_GONGCHENGSHI], Mnatk_dex_rad2[JOB_TYPE_GONGCHENGSHI] = 0.8, 0.8, 0, 0					--×îÐ¡¹¥»÷Á¦µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Mxatk_str_rad1[JOB_TYPE_GONGCHENGSHI], Mxatk_str_rad2[JOB_TYPE_GONGCHENGSHI], Mxatk_dex_rad1[JOB_TYPE_GONGCHENGSHI], Mxatk_dex_rad2[JOB_TYPE_GONGCHENGSHI] = 0.8, 0.8, 0, 0 					--×î´ó¹¥»÷µÄÊôÐÔÓ°ÏìÏµÊý£ºÁ¦Á¿ÏµÊý
		Def_con_rad1[JOB_TYPE_GONGCHENGSHI], Def_con_rad2[JOB_TYPE_GONGCHENGSHI] = 0.5, 0.5 									--·ÀÓùµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý
		Hit_dex_rad1[JOB_TYPE_GONGCHENGSHI], Hit_dex_rad2[JOB_TYPE_GONGCHENGSHI] = 0.31, 0.15 									--ÃüÖÐµÄÊôÐÔÓ°ÏìÏµÊý£º×¨×¢ÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÃüÖÐÂÊ
		Flee_agi_rad1[JOB_TYPE_GONGCHENGSHI], Flee_agi_rad2[JOB_TYPE_GONGCHENGSHI] = 0.31, 0.15									--ÉÁ±ÜµÄÊôÐÔÓ°ÏìÏµÊý£ºÃô½ÝÏµÊý¡¢µÈ¼¶ÏµÊý¡¢×îÐ¡ÉÁ±ÜÂÊ
--		Mf_luk_rad[JOB_TYPE_GONGCHENGSHI] = 0.39	--Íåíóæíûé ïàðàìåòð
--		Crt_luk_rad[JOB_TYPE_GONGCHENGSHI] = 0.31	--Íåíóæíûé ïàðàìåòð
		Hrec_bsmxhp_rad[JOB_TYPE_GONGCHENGSHI], Hrec_con_rad[JOB_TYPE_GONGCHENGSHI] = 1/200, 1/100								--hp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óhpÏµÊý¡¢µÈ¼¶ÏµÊý¡¢hp×îÐ¡»Ø¸´ËÙ¶È
		Srec_bsmxsp_rad[JOB_TYPE_GONGCHENGSHI], Srec_sta_rad[JOB_TYPE_GONGCHENGSHI] = 1/200, 1/120									--sp»Ø¸´µÄÊôÐÔÓ°ÏìÏµÊý£º×î´óspÏµÊý¡¢µÈ¼¶ÏµÊý¡¢sp×îÐ¡»Ø¸´ËÙ¶È
		Aspd_agi_rad[JOB_TYPE_GONGCHENGSHI]	= 1.1   												 		--¹¥»÷ÆµÂÊµÄÊôÐÔÓ°ÏìÏµÊý£º»ù´¡¹¥»÷¡¢Ãô½ÝÏµÊý¡¢×îÐ¡¹¥»÷ÆµÂÊ			
...
--		SystemNotice ( role , Cha_name ) 
	...
	if lv == 100 then
		HelpInfo(role,0,"Ïîçäðàâëÿåì! Âû äîñòèãëè 100 óðîâíÿ, âàø ïîäàðîê âî âðåìåííîì ìåøêå.")
...
------------------------------------------------------
	...
	if ret == LUA_TRUE then
		...
		if lv <= 40 then
			...
			if MENTOR_ITEMID > 0 then GiveItemX( role , 0 , MENTOR_ITEMID  , 1 , 4 ) end
		end

		if lv == 41 then
			HelpInfo(role,0,"Ïîçäðàâëÿåì! Òåïåðü âû êâàëèôèöèðîâàííûé íàñòàâíèê! Âû ìîæåòå îáó÷àòü ñîáñòâåííûõ ó÷åíèêîâ. ")
			AddCreditX(role, 300)
		...
		if ModuleMentorSystem == 1 then
			MentorsAndDisciples(role)
		else
		end
	end
end 
...
--------------------------------------------------------------
--				Íîâàÿ ñèñèòåìà ìåíòîð - ó÷åíèê				--
--------------------------------------------------------------
function MentorsAndDisciples(role)
	...
	if CheckTeam == 1 then
		...
		LG('MentorsAndDisciples', 'Íà÷àëàñü ðàáîòà ôóíêöèè Ìåíòîð è ó÷åíèê:')
		if ChaName == nil or ID == nil then
			LG('MentorsAndDisciples', 'Êðèòè÷åñêàÿ îøèáêà!!! êîä: 5')
			LG('MentorsAndDisciples', '----------------------------------------------')
			return
		end
		LG('MentorsAndDisciples', 'Èìÿ Ó÷åíèêà: '..ChaName..'(ID = '..ID..')')
		local lv_disciples = Lv ( role )
		LG('MentorsAndDisciples', 'Ó÷åíèê ñîâåðøèë ïîäúåì óðîâíÿ äî: '..lv_disciples..'.')
		local count = 0
		local player = {}
		player[0] = role
		...
		--Ñîñ÷èòàåì êîëè÷åñòâî ÷åëîâåê â îòðÿäå
		for i = 0 , 4 , 1 do
			if ValidCha( player[i] ) == 1 then
				...
				if star == 1 then
					...
					LG('MentorsAndDisciples', 'Ëèäåðîì îòðÿäà ÿâëÿåòñÿ èãðîê: '..mentor_name..'('..mentor_ID..')')
					LG('MentorsAndDisciples', 'Íà÷àëî ïðîâåðîê ìåíòîðà è ó÷åíèêà!')
					local IsValidTeam = IsValidTeam ( player[i] )
					if IsValidTeam == nil then
						LG('MentorsAndDisciples', 'Èãðîêè íå ÿâëÿþòñÿ ìåíòîðîì è ó÷åíèêîì! Çàâåðøåíèå ðàáîòû ôóíêöèè!')
						LG('MentorsAndDisciples', '----------------------------------------------')
						return
					elseif IsValidTeam == 1 then
						LG('MentorsAndDisciples', 'Èãðîêè ÿâëÿþòñÿ ìåíòîðîì è ó÷åíèêîì! Âûäà÷à ïðèçîâ ìåíòîðó!')
						local mentor = player[i]
						local lvl = lv_disciples
						if lvl >= 10 and lvl <= 40 then
							if lvl == 10 then
								GiveItemX( mentor , 0 , 8141  , 1 , 4 )
							elseif lvl == 15 then
								GiveItemX( mentor , 0 , 8141  , 1 , 4 )
							elseif lvl == 20 then
								GiveItemX( mentor , 0 , 8141  , 1 , 4 )
						...
						elseif lvl >= 41 and lvl <= 64 then
							GiveItemX( mentor , 0 , 8141  , 1 , 4 )
						elseif lvl >= 65 and lvl <= 84 then
							GiveItemX( mentor , 0 , 8142  , 1 , 4 )
						elseif lvl >= 85 and lvl <= 99 then
							GiveItemX( mentor , 0 , 8143  , 1 , 4 )
						elseif lvl == 100 then
							GiveItemX( mentor , 0 , 8144  , 1 , 4 )
						end
						LG('MentorsAndDisciples', 'Âûäà÷à ïðèçîâ çàâåðùåíà, çàâåðøåíèå ðàáîòû ôóíêöèè!')
						LG('MentorsAndDisciples', '----------------------------------------------')
						SystemNotice(mentor,'Âàø ó÷åíèê äîñòèã íîâîãî óðîâíÿ, âû ïîëó÷èëè íàãðàäó. Ïðîäîëæàéòå â òîì æå äóõå!')
						return
					end
				end
			end
...
function ExAttrCheck(role)  --[[»ù±¾À©Õ¹ÊôÐÔ¼ÆËã]]--
	...
	local mxhp	= math.floor(Con(role)*3 * Mxhp_con_rad1[job] + Mxhp_con_rad2[job] * math.pow( math.floor(Con(role)*3/20 ),  2) +Lv(role) * Mxhp_lv_rad[job] + 40)	--Ìàêñèìàëüíîå çäîðîâüå
	...
	local bcolexp = 100
	--local bsmf = 100
	local mf = 100			--Áûë ðàíåå = 100 + math.floor( Luk(role)*3 * Mf_luk_rad[job] )
	local crt = 15			--Áûë ðàíåå = 11 + math.floor( Luk(role)*3 * Crt_luk_rad[job] )
	...
	SetCharaAttr( mxhp, role, ATTR_BMXHP )												--[[¸³Öµ»ù±¾HPÉÏÏÞ]]--
	if mxhp <= 0 then 
		LG("ChaAttr_err" , "Character" , GetChaName(role) , "Base Max HP error" )  
		LG("ChaAttr_err", "mxhp = ", mxhp,"    con = ", Con(role) , "	lv = " , Lv(role) ) 
	end 
	SetCharaAttr(mxsp, role, ATTR_BMXSP )												--[[¸³Öµ»ù±¾SPÉÏÏÞ]]--
	--LG("ChaAttr", "mxsp = ", mxsp,"\n") 
	SetCharaAttr(mnatk, role, ATTR_BMNATK )											--[[¸³Öµ»ù±¾×îÐ¡ÉËº¦Á¦]]--
	--LG("ChaAttr", "mnatk = ", mnatk,"\n") 
	SetCharaAttr(mxatk, role, ATTR_BMXATK )												--[[¸³Öµ»ù±¾×î´óÉËº¦Á¦]]--
	--LG("ChaAttr", "mxatk = ", mxatk,"\n") 
	SetCharaAttr(def, role, ATTR_BDEF )													--[[¸³Öµ»ù±¾·ÀÓùÁ¦]]--
	--LG("ChaAttr", "def= ", def,"\n") 
	SetCharaAttr(hit, role, ATTR_BHIT)													--[[¸³Öµ»ù±¾ÃüÖÐÂÊ]]--
	--LG("ChaAttr", "hit= ", hit,"\n") 
	SetCharaAttr(flee, role, ATTR_BFLEE)												--[[¸³Öµ»ù±¾ÉÁ±ÜÂÊ]]--
	--LG("ChaAttr", "flee= ",flee,"\n") 
	SetCharaAttr(mf, role, ATTR_BMF)													--[[¸³Öµ»ù±¾MFÂÊ]]--
	--LG("ChaAttr", "mf= ", mf,"\n") 
	SetCharaAttr(crt, role, ATTR_BCRT)													--[[¸³Öµ»ù±¾±©»÷ÂÊ]]--
	--LG("ChaAttr", "crt= ", crt,"\n") 
	SetCharaAttr(hrec, role, ATTR_BHREC)												--[[¸³Öµ»ù±¾HP»Ø¸´ËÙ¶È]]--
	--SetCharaAttr(bsmf, role, ATTR_STATEV_MF)
	SetCharaAttr(bcolexp, role, ATTR_BCOL)
	if hrec<= 0 then 
	...
	SetCharaAttr(srec, role, ATTR_BSREC)												--[[¸³Öµ»ù±¾SP»Ø¸´ËÙ¶È]]--
	if srec<= 0 then 
	...
	SetCharaAttr(aspd, role, ATTR_BASPD) 												--[[¸³Öµ»ù±¾¹¥»÷ËÙ¶È]]--
...
--	SystemNotice (role,"enter ship recover")
		...
		if sp <= 0 then 
			BickerNotice ( role , "Òîïëèâî çàêàí÷èâàåòñÿ! Ñóäíî ïîëó÷àåò ïîâðåæäåíèÿ! Îòïðàâëÿéòåñü â áëèæàéøèé ïîðò! " ) 
