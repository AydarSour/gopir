print(" ")
print("-------------------------------------------------------------------------------")
print("                             PKO 1.38 v1.05 [RUS]                              ")
print("-------------------------------------------------------------------------------")
print("                                   ChangeLog:                                  ")
print(" - à·Ø‡†¢´•≠Î *.res ‰†©´Î                                                      ")
print(" - ç†¢Î™ 'í•´Æ î•®' §†•‚ Ø‡®°†¢™„ ™ ·‚†‚†¨                                     ")
print(" - í•Ø•‡Ï ß† ·¨•‡‚Ï ≠†™´†§Î¢†•‚·Ô Ë‚‡†‰ (èÆ‚•‡Ô ÆØÎ‚† ® Ø‡ÆÁ≠Æ·‚®)             ")
print(" - èÆ·´• Ø•‡•‡Æ¶§•≠®Ô ≠†¢Î™ 'ìßÎ ãÓ°¢®' ≠• Ø‡ÆØ†§†•‚                           ")
print(" - ì°‡†´ ´®Ë≠®• ‰†©´Î ®ß Ø†‚Á†                                                 ")
print(" - Ö·‚Ï Æ°‡†°Æ‚Á®™ Á†‚†, Ø‡Æ¢•‡™† GM ì‡Æ¢≠Ô, ‚‡†≠·‰Æ‡¨†Ê®Ô Ø•‡·Æ≠†¶†           ")
print(" - ì°‡†´ FilterServer (äÆ¨„ ≠„¶≠Æ, ‚Æ‚ ·†¨ ·•°• ØÆ·‚†¢®‚)                      ")
print(" - ÑÆ°†¢´•≠† ·®·‚•¨† Ä≠‚®ÑÓØ†                                                  ")
print(" ")
print("-------------------------------------------------------------------------------")
