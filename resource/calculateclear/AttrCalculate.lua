...
--Прирост характеристик класса Чемпион
		--1.Прирост хп от кона.2 Прирост хп от кона 3.Прирост хп от лвла
		Mxhp_con_rad1[JOB_TYPE_JUJS], Mxhp_con_rad2[JOB_TYPE_JUJS], Mxhp_lv_rad[JOB_TYPE_JUJS] = 6,7,43 						
		--1. Прирост маны от духа 2. прирост маны от духа 3. Прирост маны от лвла
		Mxsp_sta_rad1[JOB_TYPE_JUJS], Mxsp_sta_rad2[JOB_TYPE_JUJS], Mxsp_lv_rad[JOB_TYPE_JUJS] = 1,0,3 						
		--1. Прирост мин. атаки от стр 2.Прирост мин. атаки от стр. 3 Прирост мин. атаки от ловки. 4. Прирост мин. атаки от ловки
		Mnatk_str_rad1[JOB_TYPE_JUJS], Mnatk_str_rad2[JOB_TYPE_JUJS], Mnatk_dex_rad1[JOB_TYPE_JUJS], Mnatk_dex_rad2[JOB_TYPE_JUJS] = 2,0.37, 0, 0				
		--1. Прирост макс. атаки от стр 2.Прирост макс. атаки от стр. 3 Прирост макс. атаки от ловки. 4. Прирост макс. атаки от ловки
		Mxatk_str_rad1[JOB_TYPE_JUJS], Mxatk_str_rad2[JOB_TYPE_JUJS], Mxatk_dex_rad1[JOB_TYPE_JUJS], Mxatk_dex_rad2[JOB_TYPE_JUJS] =  2,0.37, 0, 0				
		--1.Деф от кона 2. Деф от кона
		Def_con_rad1[JOB_TYPE_JUJS], Def_con_rad2[JOB_TYPE_JUJS] = 0.2,0.49 	
		--1.Хит рейт от акк 2. Хит рейт от акк	
...
--Прирост характеристик класса Стрелок	
		...
		--1.Хит рейт от акк 2. Хит рейт от акк
		Hit_dex_rad1[JOB_TYPE_JUJISHOU], Hit_dex_rad2[JOB_TYPE_JUJISHOU] = 0.8, 0 	
		--1.Додж от аги 2. Додж от аги	
...
--Прирост характеристик класса Клерик		
		--1.Прирост хп от кона.2 Прирост хп от кона 3.Прирост хп от лвла
		Mxhp_con_rad1[JOB_TYPE_SHENGZHIZHE], Mxhp_con_rad2[JOB_TYPE_SHENGZHIZHE], Mxhp_lv_rad[JOB_TYPE_SHENGZHIZHE] = 	6	,	6	, 30					
		--1. Прирост маны от духа 2. прирост маны от духа 3. Прирост маны от лвла
		Mxsp_sta_rad1[JOB_TYPE_SHENGZHIZHE], Mxsp_sta_rad2[JOB_TYPE_SHENGZHIZHE], Mxsp_lv_rad[JOB_TYPE_SHENGZHIZHE] = 		4	,	4	, 6					
		--1. Прирост мин. атаки от стр 2.Прирост мин. атаки от стр. 3 Прирост мин. атаки от ловки. 4. Прирост мин. атаки от ловки
		Mnatk_str_rad1[JOB_TYPE_SHENGZHIZHE], Mnatk_str_rad2[JOB_TYPE_SHENGZHIZHE], Mnatk_dex_rad1[JOB_TYPE_SHENGZHIZHE], Mnatk_dex_rad2[JOB_TYPE_SHENGZHIZHE] = 1.7,	0.6,		0,	0			
		--1. Прирост макс. атаки от стр 2.Прирост макс. атаки от стр. 3 Прирост макс. атаки от ловки. 4. Прирост макс. атаки от ловки
		Mxatk_str_rad1[JOB_TYPE_SHENGZHIZHE], Mxatk_str_rad2[JOB_TYPE_SHENGZHIZHE], Mxatk_dex_rad1[JOB_TYPE_SHENGZHIZHE], Mxatk_dex_rad2[JOB_TYPE_SHENGZHIZHE] = 1.7,	0.6,		0,	0			
		--1.Деф от кона 2. Деф от кона
...
--Прирост характеристик класса Колдунья	
		--1.Прирост хп от кона.2 Прирост хп от кона 3.Прирост хп от лвла
		Mxhp_con_rad1[JOB_TYPE_FENGYINSHI], Mxhp_con_rad2[JOB_TYPE_FENGYINSHI], Mxhp_lv_rad[JOB_TYPE_FENGYINSHI] = 	6	,	6	, 37						
		--1. Прирост маны от духа 2. прирост маны от духа 3. Прирост маны от лвла
		Mxsp_sta_rad1[JOB_TYPE_FENGYINSHI], Mxsp_sta_rad2[JOB_TYPE_FENGYINSHI], Mxsp_lv_rad[JOB_TYPE_FENGYINSHI] = 		5	,	5	, 6						
		--1. Прирост мин. атаки от стр 2.Прирост мин. атаки от стр. 3 Прирост мин. атаки от ловки. 4. Прирост мин. атаки от ловки
...
--Прирост характеристик класса Покоритель Морей
		...
		--1.Деф от кона 2. Деф от кона
		Def_con_rad1[JOB_TYPE_HANGHAISHI], Def_con_rad2[JOB_TYPE_HANGHAISHI] =  		0.15	,	0.15 									
		--1.Хит рейт от акк 2. Хит рейт от акк
...
function Shengji_Shuxingchengzhang( role ) 
	...
	if lv== 15 then
		HelpInfo(role,0,"Поздравляем! Вы достигли 15 уровня, ваш подарок во временном мешке.")
		GiveItemX( role , 0 , 1848  , 30 , 4 )
	end
	
	if lv== 20 then
		HelpInfo(role,0,"Поздравляем! Вы достигли 20 уровня, ваш подарок во временном мешке.")
		GiveItemX( role , 0 , 1848  , 50 , 4 )
	end
	
	if lv== 25 then
		HelpInfo(role,0,"Поздравляем! Вы достигли 25 уровня, ваш подарок во временном мешке.")
	...
	if lv== 35 then
		HelpInfo(role,0,"Поздравляем! Вы достигли 35 уровня, ваш подарок во временном мешке.")
	...
	if lv== 40 then
		HelpInfo(role,0,"Поздравляем! Вы достигли 40 уровня, ваш подарок во временном мешке.")
		GiveItemX( role , 0 , 8290  , 30 , 4 )
...
function ExAttrCheck(role) 
	...
	local mxhp	= math.floor(Con(role)*3 * Mxhp_con_rad1[job] + Mxhp_con_rad2[job] * math.pow( math.floor(Con(role)*3/20 ),  2) +Lv(role) * Mxhp_lv_rad[job] + 40)	--Максимальное здоровье
	local mxsp	= math.floor(Sta(role)*3 * Mxsp_sta_rad1[job] + Mxsp_sta_rad2[job] * math.pow( math.floor(Sta(role)*3/20), 2) +Lv(role) * Mxsp_lv_rad[job] + 5)		--Максимальная мана
