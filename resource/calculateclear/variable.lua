...
--Реклама
notices = {}
notices[1] = "Сайт нашего проекта - http://veiron.ru/ "
notices[2] = "Посетите нашу группу - vk.com/veiron_online"
...
notices[6] = "Не забудь проголосовать!"
notices[6] = "Какие-то проблемы? Обратись в тех раздел форума http://veiron.ru/forum/ !"
...
EXP_BOAT_RAID			=	3		-- Рейты коробля
EXP_QUEST_RAID			=	4		-- Рейты на квесты
MONEY_RAID_QUEST		=	2.5		-- Рейты на золото(квест)
Resource_RAID_ADJUST	=	2		-- Рейт на ресурсы
LIFE_EXP				=	1.3		-- Рейты на лайф
ELEEXP_GETRAD			=	14		-- Рейты на кач феи

AUTO_RAID_MF_START		=	1		-- Авто рейты на выходные(1 вкл\0 выкл)
BOGEXP_GETRAD			=	10		-- Рейты на кач феи бога
TeamExp_RAID			=	0.3		-- Рейты на кач в отряде
MENTOR_ITEMID			=	1		-- Дополнительный итем ученику к мини-усилителям натиска
...
--Обмен меди
ChangeItemList[167]=	{	8141	,	25	,	8548	,	1	}--Умения
...
ChangeItemList[174]=	{	8141	,	35	,	454	,	1	}--Катализатор
ChangeItemList[175]=	{	8141	,	35	,	456	,	1	}--Кристалл
ChangeItemList[176]=	{	8141	,	35	,	890	,	1	}--Стабилизатор
ChangeItemList[177]=	{	8141	,	35	,	891	,	1	}--Катализатор
ChangeItemList[178]=	{	8141	,	35	,	1001	,	10	}--Чертежи
ChangeItemList[179]=	{	8141	,	60	,	1002	,	5	}
ChangeItemList[180]=	{	8141	,	90	,	1003	,	1	}
ChangeItemList[181]=	{	8141	,	50	,	1807	,	1	}--Парикм расп
ChangeItemList[182]=	{	8141	,	10	,	3389	,	1	}--Искрящийся камень
ChangeItemList[183]=	{	8141	,	10	,	3135	,	1	}--Чудомазь

--Ланга
ChangeItemList[184]=	{	1762	,	10	,	262	,	1	}	--Каробочка фей
ChangeItemList[185]=	{	8143	,	1	,	8272	,	1	}--Скиллы фей

ChangeItemList[186]=	{	8141	,	99	,	8142	,	1	}--Медью->Серебро
ChangeItemList[187]=	{	8141	,	1	,	8141	,	99	}--Серебро->Медь
...
ChangeItemList[235]=	{	8142	,	10	,	3883	,	1	}--ССФ
ChangeItemList[236]=	{	8142	,	10	,	3884	,	1	}--КОФ
ChangeItemList[237]=	{	8142	,	10	,	8551	,	1	}--
...
--Монеты за задание
ChangeItemList[244]=	{	8288	,	5	,	8548	,	1	}--Монета за задание - книга
ChangeItemList[245]=	{	8288	,	5	,	8141	,	10	}--Монета за задание жетон
ChangeItemList[246]=	{	8288	,	15	,	7792	,	1	}--Туман
ChangeItemList[247]=	{	8288	,	25	,	7793	,	1	}--Волнолом

ChangeItemList[248]=	{	8141	,	15	,	885	,	1	}--реф
ChangeItemList[249]=	{	8141	,	20	,	8613	,	1	}--
ChangeItemList[250]=	{	8141	,	40	,	8614	,	1	}--
ChangeItemList[251]=	{	8142	,	3	,	8615	,	1	}--
ChangeItemList[252]=	{	8142	,	7	,	8616	,	1	}--



--Предметы для торговцев
ChangeItemList[253]=	{	465	,	77	,	8141	,	10	}--
ChangeItemList[254]=	{	4545	,	54	,	8141	,	15	}--
ChangeItemList[255]=	{	1584	,	65	,	8141	,	17	}--
ChangeItemList[256]=	{	1631	,	99	,	8141	,	13	}--
ChangeItemList[257]=	{	3133	,	75	,	8141	,	23	}--
ChangeItemList[258]=	{	3365	,	99	,	8141	,	35	}--
ChangeItemList[259]=	{	4896	,	26	,	8141	,	5	}--

ChangeItemList[260]=	{	4889	,	15	,	8141	,	99	}--
ChangeItemList[261]=	{	4887	,	10	,	8141	,	60	}--
ChangeItemList[262]=	{	4866	,	99	,	8141	,	3	}--
ChangeItemList[263]=	{	4896	,	80	,	8141	,	65	}--
ChangeItemList[264]=	{	4863	,	27	,	8141	,	88	}--
ChangeItemList[265]=	{	4864	,	36	,	8142	,	1	}--
ChangeItemList[266]=	{	4857	,	54	,	8141	,	36	}--
ChangeItemList[267]=	{	4860	,	34	,	8141	,	22	}--
ChangeItemList[268]=	{	4796	,	99	,	8141	,	25	}--
ChangeItemList[269]=	{	4791	,	99	,	8141	,	32	}--

ChangeItemList[270]=	{	4790	,	99	,	8141	,	15	}--
ChangeItemList[271]=	{	4801	,	99	,	8141	,	22	}--
ChangeItemList[272]=	{	4800	,	99	,	8141	,	10	}--
ChangeItemList[273]=	{	4784	,	25	,	8142	,	1	}--
ChangeItemList[274]=	{	4767	,	22	,	8142	,	3	}--
ChangeItemList[275]=	{	4763	,	25	,	8142	,	2	}--
ChangeItemList[276]=	{	4759	,	19	,	8141	,	23	}--
ChangeItemList[277]=	{	4756	,	28	,	8141	,	17	}--
ChangeItemList[278]=	{	1256	,	99	,	8141	,	14	}--
ChangeItemList[279]=	{	1237	,	99	,	8141	,	20	}--

ChangeItemList[280]=	{	4955	,	99	,	8141	,	31	}--
ChangeItemList[281]=	{	1241	,	99	,	8141	,	26	}--
ChangeItemList[282]=	{	1327	,	99	,	8141	,	17	}--
ChangeItemList[283]=	{	4939	,	99	,	8141	,	33	}--
ChangeItemList[284]=	{	3139	,	99	,	8141	,	20	}--
ChangeItemList[285]=	{	1793	,	99	,	8141	,	31	}--
ChangeItemList[286]=	{	1274	,	99	,	8141	,	54	}--
ChangeItemList[287]=	{	1353	,	99	,	8141	,	39	}--
ChangeItemList[288]=	{	1184	,	99	,	8141	,	27	}--
ChangeItemList[289]=	{	4983	,	99	,	8141	,	16	}--

ChangeItemList[290]=	{	4955	,	99	,	8141	,	31	}--

--Починка предметов
Item_CanRepair_Num = 11
Item_CanRepair_ID = { }
Item_CanRepair_ID [0]  =		1	--ЅЈ
Item_CanRepair_ID [1]  =		2	--ѕЮЅЈ
Item_CanRepair_ID [2]  =		3	--№­
Item_CanRepair_ID [3]  =		4	--»рЗ№
Item_CanRepair_ID [4]  =		7	--Ш°КЧ
Item_CanRepair_ID [5]  =		11	--¶ЬЕЖ
Item_CanRepair_ID [6]  =		20	--Г±ЧУ
Item_CanRepair_ID [7]  =		22	--ТВ·ю
Item_CanRepair_ID [8]  =		23	--КЦМЧ
Item_CanRepair_ID [9]  =		24	--Р¬ЧУ
Item_CanRepair_ID [10] =		27	--ОЖЙн
Item_CanRepair_ID [11] =		9	--·ЁХИ
...
--------------------------
	...
	SKIP_ID	[	77	]	=	4459	--Хорошая оленья шкура(100000)
	SKIP_ID	[	78	]	=	4731	--Прекрасные туземные перья
	SKIP_ID	[	79	]	=	4936	--Высушенные покровы медузы
	SKIP_ID	[	80	]	=	4956	--Высушенная дельфинья шкура
	SKIP_ID	[	81	]	=	4782	--Саван
	SKIP_ID	[	82	]	=	4896	--ВЫПЕЛЕННО!1697	--Шкура ящера(100000)
	SKIP_ID	[	83	]	=	4896	--Гигантская шкура
	SKIP_ID	[	84	]	=	4958	--Одержимая шкура выползня
	SKIP_ID	[	85	]	=	4977	--Мясистый хвост выползня
	SKIP_ID	[	86	]	=	4724	--Проклятый саван
	SKIP_ID	[	87	]	=	1703	--Светящиеся покровы медузы
	SKIP_ID	[	88	]	=	1347	--Волосы проклятой русалки
	SKIP_ID	[	89	]	=	4993	--Большие липкие покровы медузы
	SKIP_ID	[	90	]	=	1734	--Тонкое изящное перо
	SKIP_ID	[	91	]	=	4974	--ВЫПЕЛЕННО!1730	--Декоративное перо(100000)
	SKIP_ID	[	92	]	=	1712	--Мех белого медведя(100000)

	SKIP_ID	[	93	]	=	1734	--Перо вождя(1000000)
	SKIP_ID	[	94	]	=	1621	--Блестящее перо(1000000)
...
------------------------------
	...
	TREE_ID	[	68	]	=	4727
	TREE_ID	[	69	]	=	4831
	TREE_ID	[	70	]	=	2225	--Клевер превращений(100000)
	TREE_ID	[	71	]	=	4057	--Адская трава(1000000)
...
--------------------------------і¬ј¶ѕ«Бй±¦Пдѕ«БйіЙі¤¶И

---------------------------------ТхСфОеРРВЦ»ШЛюДЪИЭID
SI=183
---------------------------------ТхСфОеРРВЦ»ШЛюДЪИЭКэБї
SN=1
--------------------------------ТхСфОеРРВЦ»ШЛюКфРФ
SA1=5
SA2=5
...
StoneItemType[10] = { 23,0 }	--Самоцвет удара (вставляется в перчатки)	      
...
StoneItemType[30] = { 24,0 }	--Сломанный Самоцвет Ветра (вставляется в ботинки)    
...
StoneItemType[33] = { 23,3,4,0 }    --Сломанный Самоцвет Удара (вставляется в перчатки, лук, пистолет)   
StoneItemType[34] = { 23,0 }    --Треснутый Самоцвет Удара (вставляется в перчатки)   
StoneItemType[35] = { 23,0 }    --Неограненный Самоцвет Удара (вставляется в перчатки)   
StoneItemType[36] = { 11,22,27,0 }	--Сломанный Самоцвет Колосса (вставляется в щиты, доспехи и тату)
...
StoneItemType[39] = { 1,2,3,4,7,9,0 }	--Сломанный Самоцвет Ярости (вставляется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
...
StoneItemType[42] =  { 1,2,3,4,7,9,0 }	--Сломанный Самоцвет Души (вставляется в мечи, двуручные мечи, луки, пистолеты, клинки покорителей морей, посохи)
...
StoneItemType[47] = { 23,0 }	--Великий Самоцвет Удара (вставляется в перчатки)
...
StoneItemType[63] = { 24,0 }				--Разум черного дракона
...
QUEST_AWARD_GODBOX	=	94	--Р§№ыµИН¬ЙМіЗПдЧУµ«їЄіцОпЖ·ОЮІЫ                                                  --------------kokora
...
--220--
STATE_FFJGD			=	221
STATE_YSYS			=	222 --(было 43 но кажется это ошибка)
STATE_CD			=	223 --(было 199 но кажется это ошибка)
STATE_XLTX			=	224
STATE_ZSZB			=	225
STATE_CJRS			=	226
STATE_JLBYS			=	227
...
--ID3422	Сундук из Затерянного города
	...
	BaoXiang_FLBX	[	1	]	=	0764		BaoXiang_FLBX_Rad	[	1	]	=	1		BaoXiang_FLBX_Count	[	1	]	=	1--Тату Проклятого воина
