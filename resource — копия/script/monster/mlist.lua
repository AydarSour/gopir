...
if m==1 then
    ...
    PM("haifengyuchang")
    PM("jianayunshi") -- метеорит
    PM("bycduizhang")
    PM("bycdaoguai")
    PM("byyaoqianshu") -- Легендарные деревья удачи
--    PM("baiyinhuoji")
--    PM("baiyinxieemilu")
--    PM("xuerenbaiyin")
...
if m==1 then
    ...
    PM("ShuangZiKiper")
    PM("juxieKiper")
    PM("slyaoqianshu") -- Легендарные деревья удачи
--    PM("shalanhuoji")
--    PM("shalanxieemilu")
--    PM("xuerenshalan")
--    PM("huojishalan")
...
if m==1 then
    ...
    PM("binglanglinqu")
    PM("binglangyuchang")
    PM("binglangyunshi") -- метеорит
    PM("chundaoguai")
    PM("qiudaoguai")
    PM("xiadaoguai")
    PM("blbdaoguai")
    PM("blbduizhang")
    PM("blyaoqianshu") -- Легендарные деревья удачи
   -- PM("qiuxiang")
--    PM("binglanghuoji")
--    PM("binglangxieemilu")
--    PM("xuerenbinglang")
...
------
-- Логово черного дракона ПВП
-----
m = SetCurMap("heilong")
if m==1 then
    --PM("heilong1")
    --PM("heilong2") -- БД
    --LG("init", "Heilong release monster ended!")
end
